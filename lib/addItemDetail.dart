...
class AddItemDetail extends StatefulWidget {
  ...
  AddItemDetail(this.addItem, this.appBarTitle);

  @override
  State<StatefulWidget> createState() => new _AddItemDetailState(this.addItem, this.appBarTitle);
}
...
class _AddItemDetailState extends State<AddItemDetail> {
  ...
  void _update() async {
    ...
    int result;
    if (addItem.id != null) {  // Case 1: Update operation
